...
void TP_Drow_Touch_Point(uint16_t x,uint16_t y,uint32_t color);//画一个坐标校准点
void TP_Draw_Big_Point(uint16_t x,uint16_t y,uint32_t color);	//画一个大点
void LCD_DrawRoughLine(uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2,uint32_t color);//画粗一点的线
